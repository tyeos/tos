...
static void set_gdt_entry(int gdt_index, char type, char dpl) {
    ...
    item->base_low = 0;
    item->base_high = 0xC0;        // base = 0xC0000000
    item->limit_low = 0xffff;
    item->limit_high = 0x3;     // limit = 0x3FFFF
